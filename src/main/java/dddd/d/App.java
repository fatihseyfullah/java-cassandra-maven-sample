...
public class App {
	public static void main(String[] args) {
		System.out
				.println("Hello World! This is Simple Java - Cassandra Sample");
		Cluster cluster = Cluster.builder().addContactPoint("192.168.221.138")
				.build();
		...
		PreparedStatement preparedStatement = session
				.prepare("insert into user (user_id,age,first,last) values (?,?,?,?)");
